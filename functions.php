...
function mytheme_script_enqueue() {
	...
	if( is_front_page() || is_category() ){
        ...
        // wp_enqueue_style('style-for-storyes', get_template_directory_uri() . '/css/style-for-storyes.css', array(), '1.0.0', 'all');
        wp_enqueue_style('style-11', get_template_directory_uri() . '/css/style11-5.css', array(), '1.0.0', 'all');
        wp_enqueue_style('styleadvert', get_template_directory_uri() . '/css/styleadvert2.css', array(), '1.0.0', 'all');
    }else{  
        ...
        if ( get_post_format() == 'aside'){
            ...
            wp_enqueue_style('styleheader', get_template_directory_uri() . '/css/styleheader-for-story.css', array(), '1.0.0', 'all');
